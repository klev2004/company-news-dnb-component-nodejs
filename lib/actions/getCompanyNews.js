...
function processAction(msg, cfg) {
    ...
    const productText = '{
  "soapenv:Envelope": {
    "-xmlns:new": "http://services.dnb.com/NewsAndMediaProductServiceV2.0",
    ...
    "soapenv:Header": {
      "wsse:Security": {
        ...
        "wsse:UsernameToken": {
          ...
          "wsse:Username": "P2000003D5720D6CA744D0E9EA844AA3",
          "wsse:Password": {
    ...
    "soapenv:Body": {
      "new:OrderProductRequest": {
        ...
        "TransactionDetail": { "ApplicationTransactionID": "sample" },
        "OrderProductRequestDetail": {
          "InquiryDetail": { "DUNSNumber": "' + dunsnumber + '" },
          "ProductSpecification": { "DNBProductID": "NEWS_MDA" },
          "ArchiveDetail": { "ArchiveProductOptOutIndicator": "false" },
          "InquiryReferenceDetail": {
            "CustomerReferenceText": "sample",
            "CustomerBillingEndorsementText": "sample"
          }
        }
      }
    }
